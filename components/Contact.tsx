    ...
    >
      ...
      <div className="flex flex-col p-6 bg-[#1A1A1A] mx-auto rounded-xl border border-gray-300/20 gap-2 md:gap-6">
        ...
        <div className="flex justify-center items-center mt-2 md:mt-0">
          <Button className=" bg-[#1A1A1A] border border-[#D4AF38] rounded-lg text-white font-semibold cursor-pointer hover:bg-[#D4AF38] transition-all duration-300 ease-in-out hover:scale-105">
            Send Message
          </Button>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center mt-2 gap-2">
          ...
          <Button
            asChild
            className="text-white text-sm font-medium bg-[#25D366]
               hover:bg-[#25D366] transition-all hover:scale-105 duration-300"
          >
            <a
              href="https://wa.me/2348075382929"
              target="_blank"
